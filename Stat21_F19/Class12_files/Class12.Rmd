...
--
This indicates that we may be better off using $\bar{y}_{obs}$ as our "regression line" unless there are important additional predictor variables that can be included in our regression model. 
...
To check assumption 4 we can look at a QQplot of the observed response, $y_{obs}$.  
...
---
##The problem of .red[inference]
### Heteroscedasticity and statistical inference 
...
In this test we are interested in the following hypotheses: 
$$H_0: R^2 =0 \\ H_1:R^2 \neq 0$$ 
