...
#dtable1 <- read_table2("stand_you_ground.txt")  ##typo! "your" not "you"
dtable1 <- read_csv("stand_your_ground.csv")

dtable1 <- read_csv("~/Google Drive Swat/Swat docs/Stat 21/Homework/stand_your_ground.csv")  ##sometimes R won't let me set the working directory and then read in the file so it may help to specify the entire file path here 
##also, note that we are using the "read_csv()" function since this data is a .csv file
