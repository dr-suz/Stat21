---
title: "Class 15 - Part 1"
subtitle: "Introducing MLR"
author: "STAT 021 with Suzanne Thornton"
institute: "Swarthmore College"
date: "For class on Tuesday, Oct 26, 2020 (updated: `r Sys.Date()`)"
output:
...
Suppose we have a quantitative response variable, $Y$, and $p$ predictor variables $x_1$, $x_2$, $\dots$, $x_p$. A multiple linear regression model assumes the true relationship amongst these variables is: 
