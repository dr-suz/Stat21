...
Another rule of probability is that 
...
$$P(\text{False positive}) = P(A^C|B) = 0.01$$ 
...
$$P(\text{False negative})= P(A|B^C) = 0.001$$
...
$$P(A|B) = \frac{P(A\text{ and }B)}{P(B)} = \frac{0.00004995}{0.00004995+0.00099995} = 0.00497$$
