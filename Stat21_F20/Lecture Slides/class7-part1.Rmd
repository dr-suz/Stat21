...
Such **QQ plots (Quantile-quantile plots)** generalize to other distributions as well (e.g. T, Gamma, Beta, etc). These plots help us answer the question: "Is the distribution of the data similar to a normal (or T, chi-squar, etc) distribution?" 
...
.scroll-output[Interpretation: A linear relationship close to the diagonal line $x=y$ indicates a close matching of your observed data with a Normal distribution. 
