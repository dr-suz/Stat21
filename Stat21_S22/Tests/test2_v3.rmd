...
(a) $\hat{biomass} = \hat{\beta}_0$

(b) $\hat{biomass} = \hat{\beta}_0 + \hat{\beta}_1 pH + \hat{\beta}_2 K$

(c) $\hat{biomass} = \hat{\beta}_0 + \hat{\beta}_1 pH + \hat{\beta}_2 K +  \hat{\beta}_4 LocationSM$
