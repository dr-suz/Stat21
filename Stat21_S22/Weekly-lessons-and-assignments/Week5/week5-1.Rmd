...
```{r}
SAT_data <- read_table2("~/GitHub/Stat21/Data/sat_data.txt", col_names=FALSE, cols(col_character(), col_double(), col_double(), col_double(), col_double(), col_double(), col_double(), col_double()))
