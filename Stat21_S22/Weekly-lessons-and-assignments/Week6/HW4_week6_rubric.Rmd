...
author: 'Solutions sketched with rubric'
...
**Rubric:** must show some mathematical work and/or explain their reasoning with words to receive full credit 
...
**Rubric:** must show work in part (c) to receive full credit for this problem 
...
(a) Both histograms look Normal (symmetric, bell shaped, unimodal)

(b) Again, looks normal. 

(c) proportion of intervals that cover $\beta_0 = 10$ is approximately the confidence level $= 481/500 = 0.962$
 
(d) proportion of intervals that cover $\hat{y} = 100$ is approximately the confidence level $= 481/500 = 0.952$

**Rubric:** grade for correctness, each part must be correct to receive full credit 
...
**Rubric:** full credit for noting non-linearity and for interpreting the direction of the skew in (b) correctly. don't penalize if they didn't notice the non-constant variance. 
...
**Rubric:** grade part (a) for completeness but make sure they have included the test statistic in part (b) for full credit. you can grade the interpretation in part (b) for completeness as well. 
...
**Rubric:** for full credit answers must state a prediction interval and give a valid reason 
...
**Rubric:** full credit if they produced the correct plot and attempted an interpretation 
...
**Rubric:** grade this problem for completion only please 
